"""
XGBoost results for Cover Type Data Set.
...
#####
# pre processing
balanced_data, balanced_y = SMOTE(sampling_strategy='minority', k_neighbors=5).fit_resample(data.values, y)

x_train_val, x_test, y_train_val, y_test = train_test_split(balanced_data, balanced_y, train_size=0.8, shuffle=True)
